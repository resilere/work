...
# -*- coding: utf-8 -*-
"""
Created on Fri May 29 17:13:17 2020
...
#       print(input)
    ...
    def backward(self, grad_output):
        ...
        grad_input = torch.cat((torch.mul(torch.unsqueeze(dDice,1), 
            grad_output[0]), torch.mul(torch.unsqueeze(dDice,1), -grad_output[0])), dim = 1)
